    ...
    <div className="space-y-10">
      <div className="flex flex-col md:flex-row gap-8 items-start">
        <div className="flex-1 space-y-4">
          ...
          <p className="font-mono text-sm text-brutal-black/70 max-w-md leading-relaxed">
            AI-assisted data extraction and validation.
            Faster intake. Fewer errors. Better outcomes.
          </p>
        </div>
        <div className="w-full md:w-72 relative select-none">
          <div className="relative">
            ...
            <div className="relative ml-16 mt-0 w-48 h-56 bg-brutal-yellow border-[3px] border-brutal-black shadow-brutal flex flex-col items-center justify-center overflow-hidden">
            ...
            <div className="absolute -bottom-2 -right-1 bg-brutal-pink text-white px-3 py-1.5 border-[3px] border-brutal-black font-mono text-[10px] font-bold uppercase shadow-brutal-sm">
              GPT-4o
            </div>
            <div className="absolute top-0 right-0 bg-brutal-lime px-2 py-1 border-2 border-brutal-black font-mono text-[10px] font-bold">
              LIVE
            </div>
          </div>
          <div className="h-60" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Link href="/claims/new" className="brutal-card p-6 block group">
          ...
          <h3 className="brutal-heading text-xl mb-2">NEW CLAIM</h3>
          <p className="font-mono text-xs text-brutal-black/60 leading-relaxed">
            Submit a new insurance claim with AI-assisted
            data extraction and validation.
          </p>
          <div className="mt-4 pt-4 border-t-2 border-dashed border-brutal-black/20 flex items-center gap-2 font-mono text-xs font-bold uppercase text-brutal-blue">
            Start filing
        ...
        <div className="brutal-card p-6 bg-brutal-black/5 border-dashed opacity-60 cursor-not-allowed">
          ...
          <h3 className="brutal-heading text-xl mb-2">VIEW CLAIMS</h3>
          <p className="font-mono text-xs text-brutal-black/60 leading-relaxed">
            Browse, search, and manage all submitted
            claims in one place.
          </p>
          <div className="mt-4 pt-4 border-t-2 border-dashed border-brutal-black/20 flex items-center gap-2 font-mono text-xs font-bold uppercase text-brutal-black/40">
            Coming soon
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-4">
        {STATS.map((stat) => (
          <div key={stat.label} className={`${stat.color} border-[3px] border-brutal-black p-4 shadow-brutal-sm`}>
            <div className="brutal-heading text-2xl md:text-3xl">{stat.value}</div>
            <div className="font-mono text-xs text-brutal-black/70 mt-1 uppercase">{stat.label}</div>
          </div>
        ))}
      </div>
    </div>
